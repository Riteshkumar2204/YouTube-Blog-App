  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, Ritesh excels in
      ...
      <br />
      <span>
        Ritesh is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Ritesh is a big fan of cricket and
        holds immense admiration for <strong> King Kohli.</strong> His favorite
        person and biggest inspiration is his twin brother,{" "}
        <strong>Mohit.</strong> Their friendly rivalry and deep bond have
        significantly shaped Ritesh’s journey. Mohit is not only a great
        competitor but also a steadfast friend, constantly motivating Ritesh to
